...
/**
 * This function will transform a string with placeholders, with the object passed to the function
 * mapped 1:1
 *
...
function template(str = '', obj = {}) {
    ...
    return placeholders.reduce((acc, curr, idx) => acc.replace(new RegExp(`{{${curr}}}`), replacements[idx]), str);
}
